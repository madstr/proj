extern crate crypto;
    ...
    use crypto::sha2::{Sha512, Sha384, Sha512Trunc256, Sha512Trunc224, Sha256, Sha224};
	...
	pub fn sha_tests_main(){
		test_sha512();
		println!("test_sha512 O.K\n");
		test_sha384();
		println!("test_sha384 O.K\n");
		test_sha512_256();
		println!("test_sha512_256 O.K\n");
		test_sha512_224();
		println!("test_sha512_224 O.K\n");
		test_sha256();
		println!("test_sha256 O.K\n");
		test_sha224();
		println!("test_sha224 O.K\n");
